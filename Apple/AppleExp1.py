...
data_df = yf.download("AAPL", start="2012-02-01", end="2023-01-31")
# print(data_df)


# print(data_df['Close'])
data_df.to_csv('../outputs/aapl.csv')
print(data_df.shape)
...
print(valid)
valid.to_csv('../outputs/valid_predicted.csv')

# get a new quote
app_quote = yf.Ticker("AAPL")
print(app_quote.basic_info)
my_quote = yf.download("AAPL", start="2012-02-01", end="2023-01-31")
...
my_quote2 = yf.download("AAPL", start="2023-01-31", end="2023-02-02")
